var hotelswidget = new (function(window, document, $){
    ...
    this.mediaQuery = function(){
		...
		var mql1 = window.matchMedia("screen and (min-width: 1152px)");
		var mql2 = window.matchMedia("screen and (min-width: 987px) and (max-width: 1151px)");
		var mql3 = window.matchMedia("screen and (min-width: 0px) and (max-width: 986px)");
