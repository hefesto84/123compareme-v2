    ...
    this.setJavascript = {
    	...
    	setWidgetJavascript : function(){
            ...
            if (jQuery('#widget123_desplegado').length !== 0){
            	...
            	jQuery('#widget123_inform_2').css({
                    'top' : jQuery( window ).height() + 1
                });
            	jQuery('#widget123_inform_3').css({
                    'top' : jQuery( window ).height() + 1
                });
            	
            	jQuery('#widget123_inform_1').animate({
            		'top' : hotelswidget.topWidget
            	}, 2000, function(){
            		jQuery('#widget123_inform_2').animate({
                		'top' : hotelswidget.topWidget + 50
                	}, 2000, function(){
                		jQuery('#widget123_inform_3').animate({
                    		'top' : hotelswidget.topWidget + 100
                    	}, 2000, function(){
            	...
            	jQuery('#widget123_inform_close_2').click(function(){
            		jQuery('#widget123_inform_2').hide('scale',1000, function(){});
            	});
            	jQuery('#widget123_inform_close_3').click(function(){
            		jQuery('#widget123_inform_3').hide('scale',1000, function(){});
            	});
            	jQuery('#widget123_close').click(function(){
            		jQuery('#widget123_desplegado').hide('scale',1000, function(){});
            	});
            }
    	...
    	setWidgetData : function(datos,price,currency,diffDay){
            ...
            if (count === 0){
                ...
                if (jQuery('#widget123_desplegado').length !== 0){
                	...
                	jQuery('#widget123_inform_2').hide('scale',1000, function(){});
                	jQuery('#widget123_inform_3').hide('scale',1000, function(){});
                	jQuery('#widget123_desplegado').show();
                	jQuery('#widget123_desplegado').animate({
                		'top' : hotelswidget.topWidget
                	}, 2000, function(){
                		jQuery('#widget123_bottom').toggle('slide',{ direction: "up" }, 1000, function(){});
                	});
                }
            }
