...
<body>
	...
	<table class="table-edit">
		...
		<tr>
			<th>HTML</th>
			<td><textarea cols="60" rows="12" id="form_model"><s:property value="widget.model"/></textarea>
		</tr>
	<tr>
		<th></th>
	...
	var url = "<s:url value='/backend/widget-custom-html/modify'/>";
